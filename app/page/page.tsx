...
export default function Page() {
  const questions = [
    ...
    {
      questionText: "俺(私)、この戦いが終わったらあいつにプロポーズするんだ(されるんだ)、のやつ",
      answerOptions: [
        { answerText: "はい", isCorrect: true },
        { answerText: "いいえ", isCorrect: false }
      ]
